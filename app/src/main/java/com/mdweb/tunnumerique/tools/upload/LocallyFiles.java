package com.mdweb.tunnumerique.tools.upload;


import android.content.Context;

import com.mdweb.tunnumerique.tools.mdwebNetworkingLib.jsonRequest.UnicodeReader;
...
/**
 * LocallyFiles class to store, extract data into SD card.
 *
...
public class LocallyFiles {
     ...
     * @param ctx the ctx
     */
    public LocallyFiles(Context ctx) {
        context = ctx;
    }
